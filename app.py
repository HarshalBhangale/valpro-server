...
def load_csv_data():
    ...
    office_cap_rates = pd.read_csv('./updated_rentals_industrial/updated_caprates_office.csv')
    industrial_rentals = pd.read_csv('./updated_rentals_industrial/updated_rentals_industrial.csv')
